...
class Valuta(models.Model):
	...
	date_add = models.DateTimeField('Дата добавления', null = True)
...
class Employee(models.Model):
	...
	born_date = models.DateField('Дата рождения')
	country_id = models.ForeignKey(Country, verbose_name="Страна", db_column= 'country_id', on_delete = models.PROTECT)
	date_add_param = models.DateTimeField('Дата добавления параметров', null = True)
...
class Transaction(models.Model):
	...
	date_order = models.DateTimeField('Дата перевода', null = True)
